  ...
  <q-page padding>
    <q-card class="tax-report-card">
      <q-card-section>
        ...
        <q-select v-model="selectedPeriod" :options="periodOptions" label="Zeitraum auswählen" dense outlined
          class="period-select" emit-value map-options option-label="label" option-value="value"
      ...
      <!-- 📊 Charts -->
      <q-card-section>
        <h6 class="text-center q-mt-md">📊 Einnahmen vs. Ausgaben</h6>
        <DoughnutChart :revenue="financeData.total_revenue" :expenses="financeData.total_expenses" />
        <q-separator />
        <h6 class="text-center q-mt-md">📊 Monatliche Einnahmen & Ausgaben</h6>
        <BarChart :financeData="financeData" />
      </q-card-section>
